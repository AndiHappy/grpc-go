...
const (
	...
	Greeter_SayHello2_FullMethodName = "/helloworld.Greeter/SayHello2"
)
...
type GreeterClient interface {
	...
	SayHello2(ctx context.Context, in *HelloRequest2, opts ...grpc.CallOption) (*HelloReply2, error)
}
...
func (c *greeterClient) SayHello2(ctx context.Context, in *HelloRequest2, opts ...grpc.CallOption) (*HelloReply2, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloReply2)
...
type GreeterServer interface {
	...
	SayHello2(context.Context, *HelloRequest2) (*HelloReply2, error)
...
func (UnimplementedGreeterServer) SayHello2(context.Context, *HelloRequest2) (*HelloReply2, error) {
